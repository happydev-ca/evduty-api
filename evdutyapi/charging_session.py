...
class ChargingSession:
    def __init__(self, is_active: bool, is_charging: bool, volt: Volt, amp: Amp, power: Wh, energy_consumed: Wh, start_date: datetime, duration: timedelta):
    ...
    def __eq__(self, __value):
        return (self.is_active == __value.is_active and
                ...
                self.duration == __value.duration)

    @classmethod
    def no_session(cls):
        return cls(is_active=False, is_charging=False, volt=0, amp=0, power=0, energy_consumed=0, start_date=datetime.min, duration=timedelta(seconds=0))
